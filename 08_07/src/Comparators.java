...
public class Comparators
{
   ...
   public static void main(String[] args) {
	   //このreversed実装ではnullあり配列でNullpointerExceptionが発生してしまう。。
      ...
      Arrays.sort(presidents, Comparator.comparing(Person::getMiddleName, nullsFirst(Comparator.<String>reverseOrder()  )));
      System.out.println(Arrays.toString(presidents));
